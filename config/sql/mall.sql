create database if not exists sophie_mall;
use sophie_mall;
SET NAMES utf8mb4;
...
CREATE TABLE `cms_topic_comment`  (
                                      ...
                                      `show_status` int(1) NULL DEFAULT NULL,
                                      PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE utf8mb4_general_ci COMMENT = '话题评论表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2b$12$SqxSS12Z4i9LtcB.hxp.VuCVwkUHnzB4XoVA2iUDDaJoQxi4UYVPe', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_01.png', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1);
...
INSERT INTO `ums_member` VALUES (11, 4, 'sophie', '$2a$10$pqvSCueTyfwLcu/SliPYDu60vjUEphQdYqlgWEvwUCQYk8EMqpJeS', 'sophie', '17771219793', 1, '2024-05-11 15:22:38', null, 1, '2009-06-01', '上海', '学生', 'member', NULL, 5000, 1000, NULL, NULL);
