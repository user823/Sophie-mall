...
public class ConfirmOrderResult {
    ...
    //用户可用优惠券列表
    private List<com.sophie.sophiemall.main.domain.SmsCouponHistoryDetail> couponHistoryDetailList;
    //积分使用规则
    ...
    public List<com.sophie.sophiemall.main.domain.SmsCouponHistoryDetail> getCouponHistoryDetailList() {
        return couponHistoryDetailList;
    }

    public void setCouponHistoryDetailList(List<com.sophie.sophiemall.main.domain.SmsCouponHistoryDetail> couponHistoryDetailList) {
